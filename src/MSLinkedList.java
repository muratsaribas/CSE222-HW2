...
public class MSLinkedList < E > implements MSList<E>{
    // Data Fields
    ...
    /**
     * Constructor an empty MSLinkedList
     */
    public MSLinkedList(){/* empty */}
     ...
     * This method always insert the object to the end of the list
     * @param item - the item to be added
     * @return true always
     */
     ...
     * @param item to be removed from this list
     ...
     * @param item - Target element
     * @return the index of the target element or -1 if this list
    ...
    private class MSListIter implements ListIterator< E > {
